...
const unsigned char APU_rect1::lengthTable[] = { 10,254, 20,  2, 40,  4, 80,  6, 160,  8, 60, 10, 14, 12, 26, 14,
                                                 12, 16, 24, 18, 48, 20, 96, 22, 192, 24, 72, 26, 16, 28, 32, 30    };

const unsigned char APU_rect1::duty0[] = { 0, 1, 0, 0, 0, 0, 0, 0, };
const unsigned char APU_rect1::duty1[] = { 0, 1, 1, 0, 0, 0, 0, 0, };
const unsigned char APU_rect1::duty2[] = { 0, 1, 1, 1, 1, 0, 0, 0, };
const unsigned char APU_rect1::duty3[] = { 1, 0, 0, 1, 1, 1, 1, 1, };

//    **********
//    APU Rectangle 1 Render Sample
char APU_rect1::renderSample()
{
...
//    **********
//    APU Rectangle 1 Update Envelope
void APU_rect1::updateEnvelope()
{
    if(decayReset)
    {
...
void APU_rect1::updateSweep()
{
    if(sweepEnable && !sweepSilence)
    {
        ...
        else
        {
            ...
            if(!sweepNeg)    // Sweep Upward
            {
                period += period >> sweepShift;
            }
            else if(sweepNeg)    // Sweep Downward
            {
...
//    **********
//    APU Rectangle 1 Check Sweep Silence and Update Frequency
void APU_rect1::checkSweepSilence()
{
    sweepSilence = false;
...
//    **********
//    APU Rectangle 1 Update Length Counter
void APU_rect1::updateLengthCounter()
{
